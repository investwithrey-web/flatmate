...
export default function PostPropertyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.images.length < MIN_PROPERTY_IMAGES) {
      alert(
        `Please upload at least ${MIN_PROPERTY_IMAGES} property images (you selected ${formData.images.length}).`
      );
      return;
    }
    ...
    <div className="min-h-screen bg-black text-white px-6 py-12">
      <div className="max-w-6xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
          ...
          <div className="glassCard">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <option value="Bed in Shared Room">
                  Bed in Shared Room
                </option>
              </select>
          ...
          {/* FLAT VIBE */}
          <div className="glassCard">
            <h2 className="sectionTitle">Flat Vibe</h2>
          ...
          <div className="glassCard">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Required: at least {MIN_PROPERTY_IMAGES} images. Select them all in one go (hold Ctrl/Cmd to pick multiple).
            </p>
            ...
            <p
              className={`mt-3 text-sm font-medium ${
                formData.images.length >= MIN_PROPERTY_IMAGES
                  ? "text-green-400"
                  : "text-amber-400"
              }`}
            >
              {formData.images.length} / {MIN_PROPERTY_IMAGES} images selected
            </p>
          ...
          <button
            type="submit"
            disabled={isSubmitting || formData.images.length < MIN_PROPERTY_IMAGES}
